    ...
    <form action="">
         <div>
            ...
            <table>
                ...
                <tr>
                    <th id="text">Mobile</th>
                    <th><input type="text" name="mobile" id="mobile" placeholder="mobile number"></th>
                </tr>
                <tr>
                    <th id="text">Picture</th>
                    <th><input type="text" name="picture" id="picture" placeholder="upload your photo"></th>
                </tr>
                ...
                <tr>
                    ...
                    <th><button id="signup"><a href="/students/otp" style="color: white;text-decoration: none;">Signup</a></button></th>
         ...
         <h4>Already have an account?<a href="/students/login"><span>Login</span></a></h4>
    </form>
</body>
</html>